...
const Login = () => {
  return (
    <form className='pt-10 max-w-sm mx-auto'>
      <h1 className='text-3xl font-bold mb-4 text-center dark:text-white'>Login</h1>
...
<button className="block w-[100%] mt-3 px-3 py-3 rounded-md bg-[#99a7bd] hover:bg-[#5ea4f3] hover:font-semibold">Login</button>
</div>
    </form>
  )
}
